...
void MX_FREERTOS_Init(void) {
  ...
  Input_HandlerHandle = osThreadNew(InputHandler, NULL, &Input_Handler_attributes);

  /* creation of Output_Handler */
  Output_HandlerHandle = osThreadNew(OutputHandler, NULL, &Output_Handler_attributes);
